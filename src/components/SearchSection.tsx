    ...
    <section className="mt-8 bg-transparent pb-32 lg:pb-40">
      <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="relative isolate overflow-hidden bg-gradient-to-b from-green-900 to-green-950 px-6 py-24 shadow-2xl sm:rounded-3xl sm:px-24 xl:py-32">
          ...
          <button className="group mx-auto mt-10 flex w-full max-w-md gap-x-4 rounded-md border-0 bg-white/5 px-3 py-2 text-stone-400 shadow-sm ring-1 ring-inset ring-white/10 transition-all hover:ring-stone-400 focus:ring-stone-400 active:scale-95 sm:text-sm sm:leading-6">
            <MagnifyingGlassIcon
